...
const { createInventoryItem, getAllInventoryItems, getInventoryItemById, getInventoryItemCount, getAllDropdown, updateInventoryItem, deleteInventoryItem, createReservation, ReserveSingleUseItems, getAllReservations, getReservationsList, getInventoryReportData, uploadInventoryImage } = require('../controllers/inventoryItemController');
...
router.get("/reservations", verifyToken, authorizeRoles("admin", "manager", "team-member"), getAllReservations);
router.get("/reservations/list", verifyToken, authorizeRoles("admin", "manager", "team-member"), getReservationsList);
