...
router.get("/upcoming-tasks", verifyToken, authorizeRoles("admin", "manager", "team-member", "client"), getUpcomingTasksByClientId);
router.get("/status-counts", verifyToken, authorizeRoles("admin", "manager", "team-member", "client"), getTaskStatusCountsByClientId);
