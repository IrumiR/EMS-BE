...
const { createBudget, getAllBudgets,getBudgetReportData, getBudgetCountsByStatus, getBudgetById, updateBudget, updateStatus, deleteBudget } = require('../controllers/budgetController');
...
router.get('/counts-by-status', verifyToken, authorizeRoles("admin", "manager"), getBudgetCountsByStatus);
